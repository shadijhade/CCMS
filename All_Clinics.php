    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media media-grid v-middle">
        ...
        <div class="media-body">
          <h3 class="text-display-2 text-white margin-none">All Clinics</h3>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="panel panel-default">
              ...
              <table data-toggle="data-table" style="overflow:auto" class="table" cellspacing="0">
                ...
                <tbody>
                  ...
                  <?php
                  $sql = mysqli_query($Conn, "select * from clinics order by ID DESC");
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="View_Clinic_Doctors.php?Clinic_ID=<?php echo $Clinic_ID; ?>" class="btn btn-success btn-sm" role="button">View</a>
