              ...
              <table data-toggle="data-table" style="overflow:auto" class="table" cellspacing="0">
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_array($sql)) {
                    ...
                    $sql1 = mysqli_query($Conn, "select * from clinics where ID='$Clinic_ID'");
                    $row1 = mysqli_fetch_array($sql1);
                    $Category_ID = $row1['Category_ID'];
                    $Name = $row1['Name'];


                    $sql1 = mysqli_query($Conn, "select * from categories where ID='$Category_ID'");
                    $row1 = mysqli_fetch_array($sql1);
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="Request_Free_Appointments_2.php?Clinic_ID=<?php echo $Clinic_ID; ?>&Doctor_ID=<?php echo $Doctor_ID; ?>" class="btn btn-success btn-sm" role="button">Select</a>
