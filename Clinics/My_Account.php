...
$Clinic_Password = $row11['Password'];
...
if (isset($_POST['Submit'])) {
  ...
  if (isvalid2() == true) {
    ...
    $update = mysqli_query($Conn, "update clinics set Password='$Confirm_New_Password_2' where ID='$C_ID'");
...
function isvalid2()
{
  ...
  global $Clinic_Password;




  if ($Clinic_Password <> $Old_Password) {
    echo "<script language='JavaScript'>
                    ...
                    <div class="media-body">
                      ...
                      <div id="account" class="tab-pane active">
                        <form class="form-horizontal" action="My_Account.php" method="post">
                          ...
                          <input type="hidden" name="Clinic_Password" value="<?php echo $Clinic_Password; ?>" />
