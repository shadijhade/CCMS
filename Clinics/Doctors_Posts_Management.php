          ...
          <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
            ...
            <div class="panel-body list-group">
              <ul class="list-group list-group-menu">
                ...
                <li class="list-group-item active"><a class="link-text-color" href="Doctors_Posts_Management.php"><span>Doctors Posts Management</span></a></li>
              </ul>
            </div>
          </div>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Doctors Posts Management</h4>
                </div>
                <ul class="list-group">
                      ...
                      <div class="panel panel-default">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            $sql1 = mysqli_query($Conn, "select * from posts where Clinic_ID='$C_ID' order by ID DESC");
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td><img src="../Doctors/Posts_Images/<?php echo $Image; ?>" width="150px" height="150px" /></td>

                                <td><?php echo $Add_Date_Time; ?></td>

                                <td>
                                  <a href="JavaScript:if(confirm('Are You Sure To Delete This Post ?')==true)
{window.location='Delete_Post.php?P_ID=<?php echo $P_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>
                                </td>
