    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">Doctors Management</h1>
        </div>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Doctors Management</h4>
                </div>
                <ul class="list-group">
                  <li class="list-group-item media v-middle">
                    <div class="media-body">

                      <h4 class="page-section-heading"><a href="Add_New_Doctor.php" class="btn btn-success btn-sm">Add New Doctor</a></h4>
                      ...
                      <div class="panel panel-default">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            $sql1 = mysqli_query($Conn, "select * from doctors where Clinic_ID='$C_ID' order by ID DESC");
                            while ($row1 = mysqli_fetch_array($sql1)) {
                              ...
                              $Major = $row1['Major'];
                              $Years_of_Experience = $row1['Years_of_Experience'];
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="JavaScript:if(confirm('Are You Sure To Delete This Doctor ?')==true)
{window.location='Delete_Doctor.php?D_ID=<?php echo $D_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>


                                  <a href="Edit_Doctor.php?D_ID=<?php echo $D_ID; ?>" class="btn btn-warning btn-sm">Edit</a>
                                </td>
