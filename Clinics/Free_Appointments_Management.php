    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">Free Appointments Management</h1>
        </div>
          ...
          <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
            ...
            <div class="panel-body list-group">
              <ul class="list-group list-group-menu">
                ...
                <li class="list-group-item active"><a class="link-text-color" href="Free_Appointments_Management.php">Free Appointments Management</a></li>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Free Appointments Management</h4>
                </div>
                <ul class="list-group">
                      ...
                      <div class="panel panel-default">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            $sql1 = mysqli_query($Conn, "select * from free_appointments where Clinic_ID='$C_ID' order by ID DESC");
                            while ($row1 = mysqli_fetch_array($sql1)) {
                              ...
                              $sql23 = mysqli_query($Conn, "select * from clinics where ID='$C_ID'");
                              $row23 = mysqli_fetch_array($sql23);
                              $C_Full_Name = $row23['Name'];
...
{window.location='Delete_Appointment.php?FA_ID=<?php echo $FA_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>
                                </td>
