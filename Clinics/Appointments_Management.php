          ...
          <ul class="nav navbar-nav navbar-nav-bordered navbar-nav-margin-right">
            ...
            <li class="dropdown user active">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="../images/logo1.png" alt="" class="img-circle" /> Clinic<span class="caret"></span>
              </a>
    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">Appointments Management</h1>
        </div>
          ...
          <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
            ...
            <div class="panel-body list-group">
              <ul class="list-group list-group-menu">
                ...
                <li class="list-group-item active"><a class="link-text-color" href="Appointments_Management.php">Appointments Management</a></li>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Appointments Management</h4>
                </div>
                <ul class="list-group">
                      ...
                      <div class="panel panel-default">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            $sql1 = mysqli_query($Conn, "select * from appointments where Clinic_ID='$C_ID' order by ID DESC");
                            while ($row1 = mysqli_fetch_array($sql1)) {
                              ...
                              $sql23 = mysqli_query($Conn, "select * from patients where ID='$Patient_ID'");
                              $row23 = mysqli_fetch_array($sql23);
                              $P_ull_Name = $row23['Full_Name'];
                              $Phone_Number = $row23['Phone_Number'];
...
{window.location='Delete_Appointment_2.php?A_ID=<?php echo $A_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>
                                </td>
