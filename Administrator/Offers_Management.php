            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Offers Management</h4>
                </div>
                <ul class="list-group">
                  <li class="list-group-item media v-middle">
                    <div class="media-body">
                      ...
                      <h4 class="page-section-heading"><a href="Add_New_Offer.php" class="btn btn-success btn-sm">Add New Offer</a></h4>
                      <div class="panel panel-default">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            <?php
                            $sql1 = mysqli_query($Conn, "select * from offers order by ID DESC");
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td><img src="../<?php echo $Image; ?>" width="150px" height="150px" /></td>
                                <td><?php echo $Add_Date_Time; ?></td>
                                <td>

                                  <a href="JavaScript:if(confirm('Are You Sure To Delete This Offer ?')==true)
{window.location='Delete_Offer.php?ID=<?php echo $ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>
                                  <a href="Edit_Offer.php?ID=<?php echo $ID; ?>" class="btn btn-warning btn-sm">Edit</a>
