...
$sql1 = mysqli_query($Conn, "select * from offers where ID='$ID'");
...
if (isset($_POST['Submit'])) {
  ...
  $update = mysqli_query($Conn, "update offers set Title='$Title', Description='$Description' where ID='$ID'");

  echo "<script language='JavaScript'>
			  alert ('Offer Information Has Been Updated !');
      </script>";
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Edit Offer Information</h4>
                </div>
                <ul class="list-group">
                  <li class="list-group-item media v-middle">
                    <div class="media-body">
                      ...
                      <div id="account" class="tab-pane active">
                        <form class="form-horizontal" action="Edit_Offer.php" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <div class="form-control-material">
                                <input type="text" class="form-control" value="<?php echo $Title; ?>" name="Title" placeholder="Offer Title" required>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <div class="form-control-material">
                                <textarea id="textarea" name="Description" placeholder="Offer Description" class="form-control" rows="5" required><?php echo $Description; ?></textarea>
                          ...
                          <div class="form-group margin-none">
                            <div class="col-md-offset-2 col-md-10">
                              <button type="submit" name="Submit" class="btn btn-primary paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated>Edit Offer Information</button>
                            </div>
                          </div>
                        </form>
                      </div>
