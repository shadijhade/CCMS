    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">Patients Testimonials</h1>
        </div>
          ...
          <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
            ...
            <div class="panel-body list-group">
              <ul class="list-group list-group-menu">
                ...
                <li class="list-group-item active"><a class="link-text-color" href="Patients_Testimonials_Management.php"><span>Patients Testimonials Management</span></a></li>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Patients Testimonials Management</h4>
                </div>
                <ul class="list-group">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              ...
                              <th>Testimonial Add Date / Time</th>
                          ...
                          <tbody>
                            ...
                            <?php
                            $sql1 = mysqli_query($Conn, "select * from patients_testimonials order by ID DESC");
                            while ($row1 = mysqli_fetch_array($sql1)) {
                              ...
                              $sql2 = mysqli_query($Conn, "select * from patients where ID='$Patient_ID'");
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="JavaScript:if(confirm('Are You Sure To Delete This Testimonial ?')==true)
{window.location='Delete_Patient_Testimonial.php?T_ID=<?php echo $T_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>
                                </td>
