...
$sql1 = mysqli_query($Conn, "select * from categories where ID='$C_ID'");
...
if (isset($_POST['Submit'])) {
  ...
  $update = mysqli_query($Conn, "update categories set Category_Name='$Category_Name' where ID='$C_ID'");
    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">Categories</h1>
        </div>
          ...
          <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
            ...
            <div class="panel-body list-group">
              <ul class="list-group list-group-menu">
                <li class="list-group-item active"><a class="link-text-color" href="Categories_Management.php">Categories Management</a></li>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Edit Category Information</h4>
                </div>
                <ul class="list-group">
                      ...
                      <div id="account" class="tab-pane active">
                        <form class="form-horizontal" action="Edit_Category.php" method="post">
                          ...
                          <div class="form-group">
                            <label for="inputPassword3" class="col-md-2 control-label">Category Name *</label>
                            <div class="col-md-6">
                              <div class="form-control-material">
                                <input type="text" class="form-control" name="Category_Name" value="<?php echo $Category_Name; ?>" placeholder="Category Name" required>
                          ...
                          <div class="form-group margin-none">
                            <div class="col-md-offset-2 col-md-10">
                              <button type="submit" name="Submit" class="btn btn-primary paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated>Edit Category Information</button>
                            </div>
                          </div>
                        </form>
                      </div>
