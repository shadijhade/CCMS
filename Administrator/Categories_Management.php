            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Categories Management</h4>
                </div>
                <ul class="list-group">
                  <li class="list-group-item media v-middle">
                    <div class="media-body">
                      ...
                      <h4 class="page-section-heading"><a href="Add_New_Category.php" class="btn btn-success btn-sm">Add New Category</a></h4>
...
{window.location='Delete_Category.php?C_ID=<?php echo $C_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>
                                  <a href="Edit_Category.php?C_ID=<?php echo $C_ID; ?>" class="btn btn-warning btn-sm">Edit</a>
