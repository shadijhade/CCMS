...
if (isset($_POST['Submit'])) {
  ...
  $sql = mysqli_query($Conn, "select * from categories where Category_Name='$Category_Name'");
  if (mysqli_num_rows($sql) > 0) {
    ...
    $sql1 = mysqli_query($Conn, "insert into categories (Category_Name) values ('$Category_Name')");
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Add New Category</h4>
                </div>
                <ul class="list-group">
                        ...
                        <form class="form-horizontal" action="Add_New_Category.php" method="post">
                          ...
                          <div class="form-group margin-none">
                            <div class="col-md-offset-2 col-md-10">
                              <button type="submit" name="Submit" class="btn btn-primary paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated>Add New Category</button>
                            </div>
                          </div>
                        </form>
                      </div>
