          ...
          <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
            ...
            <div class="panel-body list-group">
              <ul class="list-group list-group-menu">
                ...
                <li class="list-group-item active"><a class="link-text-color" href="Posts_Management.php">Posts Management</a></li>
              </ul>
            </div>
          </div>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Posts Management</h4>
                </div>
                <ul class="list-group">
                      ...
                      <div class="panel panel-default">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            <?php
                            $sql1 = mysqli_query($Conn, "select * from posts order by ID DESC");
