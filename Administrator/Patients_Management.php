    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">Patients</h1>
        </div>
          ...
          <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
            ...
            <div class="panel-body list-group">
              <ul class="list-group list-group-menu">
                ...
                <li class="list-group-item active"><a class="link-text-color" href="Patients_Management.php"><span>Patients Management</span></a></li>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Patients Management</h4>
                </div>
                <ul class="list-group">
                      ...
                      <div class="panel panel-default">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            <?php
                            $sql1 = mysqli_query($Conn, "select * from patients order by ID DESC");
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="JavaScript:if(confirm('Are You Sure To Delete This Patient ?')==true)
{window.location='Delete_Patient.php?P_ID=<?php echo $P_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>
