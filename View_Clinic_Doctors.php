...
<head>
  ...
  <title>:: View Clinic Doctors ::</title>
    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media media-grid v-middle">
        ...
        <div class="media-body">
          <h3 class="text-display-2 text-white margin-none">View Clinic Doctors</h3>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="panel panel-default">
              ...
              <table data-toggle="data-table" style="overflow:auto" class="table" cellspacing="0">
                ...
                <tbody>
                  ...
                  <?php
                  $sql = mysqli_query($Conn, "select * from doctors where Clinic_ID='$Clinic_ID' order by ID DESC");
