...
<head>
  ...
  <title>Clinics Center - Patinet Area</title>
    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">View All Clinics Doctors</h1>
        </div>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Doctors List</h4>
                </div>
                <ul class="list-group">
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="Request_Doctor.php?D_ID=<?php echo $D_ID; ?>&Clinic_ID=<?php echo $Clinic_ID; ?>" class="btn btn-success btn-sm" role="button">Request</a>
