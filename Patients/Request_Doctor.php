...
if (isset($_POST['Submit'])) {
  ...
  $sql = mysqli_query($Conn, "select * from appointments where Clinic_ID='$Clinic_ID' AND Doctor_ID='$D_ID' AND Date='$Date' AND Time='$Time'");
  ...
  if (mysqli_num_rows($sql) > 0) {
    ...
    echo "<script language='JavaScript'>
			  alert ('Sorry This Doctor Appointment Already Exsit ! Please Select Another Date / Time !');
      </script>";
...
document.location='My_Appointments.php';
    ...
    $update = mysqli_query($Conn, "insert into appointments (Patient_ID,Clinic_ID,Doctor_ID,Date,Time) values ('$P_ID','$Clinic_ID','$D_ID','$Date','$Time')");

    echo "<script language='JavaScript'>
			  alert ('New Doctor Appointment Has Been Requested !');
      </script>";
    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">Request Doctor</h1>
        </div>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Enter Needed Information</h4>
                </div>
                <ul class="list-group">
                  <li class="list-group-item media v-middle">
                    <div class="media-body">
                      ...
                      <div id="account" class="tab-pane active">
                        <form class="form-horizontal" action="Request_Doctor.php" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <div class="form-control-material">
                                <input type="date" class="form-control" id="text" value="" name="Date" required>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <div class="form-control-material">
                                <input type="time" class="form-control" id="text" value="" name="Time" required>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group margin-none">
                            <div class="col-md-offset-2 col-md-10">
                              <button type="submit" name="Submit" class="btn btn-primary paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated>Request</button>
                            </div>
                          </div>
                        </form>
                      </div>
