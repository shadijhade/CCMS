    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">My Testimonials</h1>
        </div>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">My Testimonials</h4>
                </div>
                <ul class="list-group">
                  <li class="list-group-item media v-middle">
                    <div class="media-body">

                      <h4 class="page-section-heading"><a href="Add_New_Testimonial.php" class="btn btn-success btn-sm">Add New Testimonial</a></h4>
                      ...
                      <div class="panel panel-default">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            <?php
                            $sql1 = mysqli_query($Conn, "select * from patients_testimonials where Patient_ID='$P_ID' order by ID DESC");
...
{window.location='Delete_Testimonial.php?T_ID=<?php echo $T_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>
