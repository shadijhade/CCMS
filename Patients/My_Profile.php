...
$sql11 = mysqli_query($Conn, "select * from patients where ID='$P_ID'");
...
if (isset($_POST['Submit'])) {
  ...
  $update = mysqli_query($Conn, "update patients set Full_Name='$Full_Name', Email_Address='$Email_Address', Phone_Number='$Phone_Number', Gender='$Gender', Type='$Type' where ID='$P_ID'");

  echo "<script language='JavaScript'>
			  alert ('Patient Profile Has Been Updated !');
      </script>";
    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0">Patient Profile</h1>
        </div>
            ...
            <div class="item col-xs-12 col-lg-12">
              <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-heading">
                  <h4 class="text-headline margin-none">Edit Patient Profile Information</h4>
                </div>
                <ul class="list-group">
                    ...
                    <div class="media-body">
                      ...
                      <div id="account" class="tab-pane active">
                        <form class="form-horizontal" action="My_Profile.php" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <label for="inputPassword3" class="col-md-2 control-label">Type *</label>
                            <div class="col-md-6">
                              <div class="form-control-material">
