...
$Patient_Password = $row11['Password'];
...
if (isset($_POST['Submit'])) {
  ...
  if (isvalid2() == true) {
    ...
    $update = mysqli_query($Conn, "update patients set Password='$Confirm_New_Password_2' where ID='$P_ID'");
...
function isvalid2()
{
  ...
  if ($Patient_Password <> $Old_Password) {
    echo "<script language='JavaScript'>
                    ...
                    <div class="media-body">
                      ...
                      <div id="account" class="tab-pane active">
                        <form class="form-horizontal" action="My_Account.php" method="post">
                          ...
                          <input type="hidden" name="Patient_Password" value="<?php echo $Patient_Password; ?>" />
